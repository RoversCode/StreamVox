...
```bash
uv pip install dist/streamvox-0.1.0-cp310-cp310-manylinux_2_28_x86_64.whl
```
...
完整功能说明已经拆分到独立文档，包含模型选择、本地模型目录、Prompt 使用、角色缓存、即时克隆、设备选择、合成参数、多参考 Prompt、授权说明和故障排查。
