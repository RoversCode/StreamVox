...
5. 每个key**最多只能激活100台设备**，如果有更多的设备激活需求，请联系淘宝客服。

## News
* **2026.5.4 🎉** **兼容voxcpm2**，最低显存需求6G，首包延迟仅180ms！！！、完美支持音色设计、副语言控制以及极致的音色克隆能力。
...
当前版本 StreamVox 搭载了 4 款业界领先的 TTS 模型，可根据业务场景灵活切换：
